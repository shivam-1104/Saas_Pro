...
const RemoveBackground = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700' >
      {/* left col */}
      <form onSubmit={onSumbitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' >
        ...
        <p className='text-xs text-gray-500 font-line mt-1' >Supports JPG, PNG, and other image formats</p>
